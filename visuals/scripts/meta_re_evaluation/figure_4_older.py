...
# === CONFIG ===
curve_dir = "results/meta_re_evaluation/roc_pr_curves/"  # Change this to your PR CSV directory
...
for protocol in ['same_day', 'cross_day']:
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig(os.path.join(save_dir, f"visuals/meta_re_evaluation/figure4_avg_pr_{protocol}.png"), dpi=300)
