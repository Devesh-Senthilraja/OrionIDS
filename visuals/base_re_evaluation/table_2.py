...
df = pd.read_csv("/home/devesh-senthilraja/OrionIDS/results/base_re_evaluation/per_attack_metrics.csv")
...
table2.to_csv("/home/devesh-senthilraja/OrionIDS/results/base_re_evaluation/table2_full_per_attack_metrics.csv", index=False)
